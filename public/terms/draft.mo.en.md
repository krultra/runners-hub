...
Participation in Malvikingen Opp ('the event', 'the race', 'the competition') will be fully at my own risk.

## NFIF Sanctioned Event

This event is sanctioned by the Norwegian Athletics Federation (NFIF). As a participant, I acknowledge that:

- I must hold a valid NFIF athletics license (either a full-year license or a one-time license purchased during registration)
- I agree to comply with NFIF competition rules and regulations
- Results will be reported to NFIF and may affect official rankings and statistics
